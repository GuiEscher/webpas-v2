...
import SolicitacoesList from "./solicitacoes-list.component";
...
const SolicitacoesWrapper = (props) => {
    ...
    <>
      ...
      <Box component="main" sx={{ flexGrow: 1, p: 3 }}>
        ...
        <Container sx={containerStyle}>
          <SolicitacoesList config={config} user={user} logout={logout} />
        </Container>
      </Box>
    </>
  );
...
export default SolicitacoesWrapper;
