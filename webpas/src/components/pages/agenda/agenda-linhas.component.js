        ...
        >
          ...
          {horariosInicio.map((horario) => {
            return (
              <>
                <Grid item xs={3}>
                  <Typography sx={tableHeadCss}>{horario}</Typography>
                </Grid>
              </>
            );
          })}
        ...
        >
          {filterFn.fnAgenda(tableObj).map((obj) => {
            return (
              <>
                <Grid item xs={2}>
                  <Typography sx={tableRowCss}>{obj.predio}</Typography>
                </Grid>
                <Grid item xs={2}>
                  <Typography sx={tableRowCss}>{obj.sala}</Typography>
                </Grid>
                {horariosInicio.map((horario) => {
                  return (
                    <>
                      <Grid item xs={3}>
                        ...
                        {state.horario_id && obj[horario] ? (
                          <>
                            <Typography sx={tableRowCss}>
                              {obj[horario].horario_id || ""}
                            </Typography>
                          </>
                        ) : (
                          <></>
