...
import {
    Grid, Toolbar, Button, TextField, Paper, Box, TableContainer,
    ToggleButtonGroup, ToggleButton, Dialog, DialogContent,
    Tab, Tabs, Typography, Divider, Stack, InputAdornment, IconButton
} from "@mui/material";
...
const Agenda = props => {
    ...
    return (
        <>
            ...
            <Paper elevation={0} variant="outlined" sx={{ p: 2, mb: 3, bgcolor: '#fdfdfd' }}>
                <Grid container spacing={2} alignItems="center">
                    ...
                    <Grid item xs={12} md={2} display="flex" justifyContent="flex-end">
                        <IconButton onClick={() => window.open('https://github.com/seu-repo/ajuda', '_blank')} color="primary" title="Ajuda">
                            <HelpIcon />
                        </IconButton>
                    </Grid>
                    ...
                    <Grid item xs={12} md={6} display="flex" justifyContent={{ xs: 'flex-start', md: 'flex-end' }} alignItems="center" gap={2}>
                         <Typography variant="body2" color="textSecondary">Visualização:</Typography>
