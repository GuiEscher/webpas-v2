        ...
        <BrowserRouter>
          <Routes>
            <Route
              exact
              path="/"
              element={<HomePage nav={openNav} setNav={setOpenNav} />}
            />
            <Route
              exact
              path="/login"
              element={<Login nav={openNav} setNav={setOpenNav} />}
            />
            <Route
              exact
              path="/cadastro"
              element={<Cadastro nav={openNav} setNav={setOpenNav} />}
            />
            <Route
              exact
              path="/lembrarsenha"
              element={<LembrarSenha nav={openNav} setNav={setOpenNav} />}
            />
            <Route
              exact
              path="/redefinirsenha/:resetToken"
              element={<RedefinirSenha nav={openNav} setNav={setOpenNav} />}
            />
            <Route
              path="/config"
              element={<ConfigWrapper nav={openNav} setNav={setOpenNav} />}
            />
            <Route
              path="/turmas"
              element={<TurmasWrapper nav={openNav} setNav={setOpenNav} />}
            />
            <Route
              path="/solicitacoes"
              element={
                <SolicitacoesWrapper nav={openNav} setNav={setOpenNav} />
              }
            />
            <Route
              path="/predios"
              element={<PrediosWrapper nav={openNav} setNav={setOpenNav} />}
            />
            <Route
              path="/predios/:predio"
              element={<SalasWrapper nav={openNav} setNav={setOpenNav} />}
            />
            <Route
              path="/distancias"
              element={<DistanciasWrapper nav={openNav} setNav={setOpenNav} />}
            />
            <Route
              path="/solver"
              element={<SolverWrapper nav={openNav} setNav={setOpenNav} />}
            />
            <Route
              path="/agenda"
